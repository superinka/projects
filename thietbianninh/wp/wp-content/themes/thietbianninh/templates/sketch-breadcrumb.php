...
class incart_breadcrumb_class {
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
            ...
            return __('Author', 'incart-lite') . ' : ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'incart-lite') . ' : ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search for "'.$s . '"', 'incart-lite');

        }

		if (is_404()) {            return __('Error 404', 'incart-lite');        }
...
$incart_breadcumb = new incart_breadcrumb_class();
