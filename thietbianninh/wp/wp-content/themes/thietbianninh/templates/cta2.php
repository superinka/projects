<section id="cta2">
    <div class="container">
        <div class="text-center">
            ...
            <img class="img-responsive wow fadeIn" src="<?php echo get_template_directory_uri(); ?>/assets/images/cta2/cta2-img.png" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
        </div>
    </div>
</section>